...
> ### [Our Webpage](https://duynguyen2001.github.io/Divvy-data-exploration-tool/), hosted with **GitHub Pages**.

Link to the [repository](https://github.com/duynguyen2001/Divvy-data-exploration-tool/) hosting the source code.

## 🧾 Logistics

### Group Members
 
Khanh Duy Nguyen (knguye71@uic.edu)
Raka Primardika (aprima3@uic.edu)
